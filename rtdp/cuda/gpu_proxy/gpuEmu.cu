...
//  3. Copy the results from GPU to CPU and send theem out via ZMQ.
//
//---------------------------------------------------------------------------
...
int main(int narg, char *argv[]){
    ...
    //............................................
    // Monitoring thread
    // size_t inBytes = 0, outBytes = 0, curr_InBytes = 0, curr_outBytes = 0;
    ...
    while (true) {
        ...
        std::cout << "Received buffer: " << curr_inBytes << std::endl;
        if( curr_inBytes == 0 ) { 
